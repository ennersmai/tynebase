...
import { Code, FileText, GitBranch, Sparkles, ArrowRight } from "lucide-react";

const features = [
  { icon: Code, title: "API Documentation", description: "Auto-generate and maintain API docs" },
  { icon: FileText, title: "Technical Specs", description: "Collaborate on technical specifications" },
  { icon: GitBranch, title: "ADRs", description: "Track architecture decision records" },
  { icon: Sparkles, title: "AI Assistance", description: "Generate docs from code comments" }
];
      ...
      <section className="section pt-[180px] pb-[80px]">
        <div className="container text-center">
          ...
          <p className="text-xl text-[var(--text-secondary)] max-w-[700px] mx-auto mb-10">
            Build better products with comprehensive technical documentation and seamless team collaboration.
          </p>
