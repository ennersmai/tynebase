...
import { HeadphonesIcon, Search, BookOpen, MessageSquare, ArrowRight } from "lucide-react";

const features = [
  { icon: HeadphonesIcon, title: "Support Knowledge Base", description: "Empower agents with instant answers" },
  { icon: Search, title: "Quick Search", description: "Find solutions in seconds" },
  { icon: BookOpen, title: "FAQ Management", description: "Self-service customer support" },
  { icon: MessageSquare, title: "Canned Responses", description: "Consistent, accurate replies" }
];
      ...
      <section className="section pt-[180px] pb-[80px]">
        <div className="container text-center">
          ...
          <p className="text-xl text-[var(--text-secondary)] max-w-[700px] mx-auto mb-10">
            Deliver exceptional customer support with a knowledge base that helps agents find answers instantly.
          </p>
